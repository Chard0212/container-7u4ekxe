...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-7u4ekxe.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-7u4ekxe.containers.anotherwebservice.com/
...
```
git clone git@github.com:Chard0212/container-7u4ekxe.git
cd container-7u4ekxe
```
...
```
docker attach container-7u4ekxe
```
